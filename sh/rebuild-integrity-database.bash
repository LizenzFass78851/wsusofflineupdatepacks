...
directories_and_hashes=(
    ...
    "../client/msse/x86-glb    ../client/md/hashes-msse-x86-glb.txt"
    "../client/msse/x64-glb    ../client/md/hashes-msse-x64-glb.txt"
    "../client/o2k16/glb       ../client/md/hashes-o2k16-glb.txt"
    "../client/w60/glb         ../client/md/hashes-w60-glb.txt"
    "../client/w60-x64/glb     ../client/md/hashes-w60-x64-glb.txt"
    "../client/w61/glb         ../client/md/hashes-w61-glb.txt"
    "../client/w61-x64/glb     ../client/md/hashes-w61-x64-glb.txt"
